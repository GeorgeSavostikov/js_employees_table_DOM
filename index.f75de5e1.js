    ...
    if (headElement) {
        ...
        switch(e.target.textContent){
            ...
            case "Salary":
                sortedData = [
                    ...data
                ].sort((el1, el2)=>+el1.salary.slice(1).split(",").join("") - +el2.salary.slice(1).split(",").join(""));
...
const pushNotification = (key, value)=>{
    ...
    switch(key){
        case "name":
            ...
            pElement.textContent = 'The "name" field must contain at least 4 characters.';
            break;
        case "age":
            divElement.classList.add("notification", "error");
            h2Element.textContent = "Title of Error message";
